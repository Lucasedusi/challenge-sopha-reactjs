# Desafio Sopha Tecnologia

## Descrição do Projeto

<p align="left">Aplicativo de Gerenciamento de Tarefas, lembrando que esse desafio utiliza Back-end de autenticação próprio desenvolvido em NodeJs. 
  O json-server é utilizado para simular uma base de dados </p>
...
- [x] Adicionar, Editar e Excluir, e Bloquear Tarefas
- [x] Filtrar Tarefas por: CATEGORIA
- [x] Organização de Tarefa via efeito drag-and-drop
- [x] Logout
...
```bash
# Clone este repositório
$ git clone https://github.com/Lucasedusi/challenge-sopha-reactjs.git
